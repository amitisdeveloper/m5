...
$trn_amount = explode(',',$tbl_transactions[0]['trn_amt']);
...
$trnumber = explode(',',rtrim($tbl_transactions[0]['number'],','));
 $tramount = $tbl_transactions[0]['amount'];
if(!empty($trnumber)){
...
if($tbl_transactions[0]['ander']!=0){
$cross = combinations(
   array( str_split($tbl_transactions[0]['ander']),
    str_split($tbl_transactions[0]['bahar']))
);
...
array_push($tamount,$tbl_transactions[0]['trncrs_amt']);
}
}
}
if($tbl_transactions[0]['fromto_from']!=0){
for($i=$tbl_transactions[0]['fromto_from'];$i<=$tbl_transactions[0]['fromto_to'];$i++){
//$tnumber[$i]= $trnumber[$i];
//$tamount[$i]= $tramount; 	
array_push($tnumber,$i);
array_push($tamount,$tbl_transactions[0]['fromto_amount']);
}
}
$daraf8 = explode(" ",$tbl_transactions[0]['dara_f8']);

if($tbl_transactions[0]['dara_f8']!=''){
for($i=0;$i<count($daraf8);$i++){
//$tnumber[$i]= $trnumber[$i];
//$tamount[$i]= $tramount; 	
array_push($tnumber,$daraf8[$i]);
array_push($tamount,$tbl_transactions[0]['dara_amount_f8']);
}
}//die;
if($tbl_transactions[0]['amount_akahr_andar_f8']!=''){
	$akandar = str_split($tbl_transactions[0]['akahr_andar_f8']);
	$akbahar = str_split($tbl_transactions[0]['akhar_bahar_f8']);
	$akamount = $tbl_transactions[0]['amount_akahr_andar_f8'];
	$bhamaount = $tbl_transactions[0]['amount_akahr_bahar_f8'];
