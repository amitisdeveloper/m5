...
<div class="col-md-3 col-sm-12  form-group"><label> Date :</label><input id="todate" class="birthday form-control" type="text" name="todate" value="<?php echo ($this->input->post('todate') ? date('Y-m-d',strtotime($this->input->post('todate'))) :'')?>" placeholder="To Date"></div>
...
<input type="submit" name="Search" Value="Search" class="btn btn-success" style="float: right;">
                      ...
                      <table id="datatable" class="table table-striped table-bordered" style="width:100%">
						...
						<?php if(is_array($tbl_transactions)&& (!empty($tbl_transactions))){
							...
							<td width="20%"><?=$val['total_amount'];?></td>
							...
							<td>
                              ...
                              <a href="/tbl_transactions/remove/<?=$val['id']?>"><i class="fa fa-minus-circle" aria-hidden="true" style="font-size:20px;"></i></a>
                            </td>
							</tr>
							<?php
