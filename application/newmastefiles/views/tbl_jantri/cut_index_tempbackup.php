                    ...
                    <tr>
                        ...
                        for ($j = 1; $j < 12; $j++) {
                            ...
                            if (isset($nnarr[$key]) && $j != '11') {
                                ...
                                <td>
                                    <span
                                        style="text-align:center;float: left;margin-right: 10px;margin-left: 5px;"><?= ($key == '100') ? '00' : $key ?></span>
                                    <input type="text" value="<?= $nnarr[$key] ?>"
                                        name="sr_<?= (($j) % 10 == 0) ? (($j) * ($i + 1)) : ($i . ($j)) ?>" id="<?= $i . $j ?>"
                                        tabindex="<?= (($j) % 10 == 0) ? (($j) * ($i + 1)) : ($i . ($j)) ?>" style="width: 65%;"
                                        class="med">
                                </td>
                                <?php
                                $ttamntt += $nnarr[$key];
                                ...
                                if ($j == '11') { ?>
                                    <td style="text-align: center;">
                                        ...
                                        <input type="text" value="<?=$trow?>" name="row_<?= $i ?>" id="<?= $i . $j ?>"
                                            tabindex="<?= (($j) % 10 == 0) ? (($j) * ($i + 1)) : ($i . ($j)) ?>" style="width: 65%;"
                                            class="medrow">
                                    </td>
                                    <?php
                                    ...
                                    <td>
                                        <span
                                            style="text-align:center;float: left;margin-right: 10px;margin-left: 5px;"><?= $key ?></span>
                                        <input type="text" value="" name="sr_<?= (($j) % 10 == 0) ? (($j) * ($i + 1)) : ($i . ($j)) ?>"
                                            id="<?= $i . $j ?>" tabindex="<?= (($j) % 10 == 0) ? (($j) * ($i + 1)) : ($i . ($j)) ?>"
                                            style="width: 65%;" class="med">
                                    </td>
                                    <?php
                                }
                            }
