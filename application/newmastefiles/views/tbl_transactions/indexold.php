            ...
            <div class="x_title">
               ...
               <div class="nav navbar-left panel_toolbox">
                  ...
                  <div class="btn-group" style="height: 36px; margin-right: 10px;">
                     ...
                     <input id="birthday" class="form-control" type="text" required="required" autocomplete="off"  >
...
<?php endif; ?>
                                                   <table >
                                                      <thead>
                                                         <tr>
                                                            <th><input type="text" class="form-control" name="trn_number[]" maxlength="2" placeholder="Number" onkeyup="checkshift()"></th>
                                                            <th><input type="text" class="form-control" name="trn_amount[]" maxlength="6" placeholder="Amount" onchange="addnumamount(this)" ></th>
                           ...
                           <div class="x_content">
                              <div class="row">
                                 <div class="col-sm-12">
									...
									<div class="col-md-8 col-sm-12 x_panel"  style="margin-top:20px;" >
<?php if($this->session->flashdata('msg')): ?>
    <p class="flsh button-success"><?php echo $this->session->flashdata('msg'); ?></p>
<?php endif; ?>									
									  <form id="demo-form2" method="post" action="add_randomf4" data-parsley-validate class="form-horizontal form-label-left">
                                          <div class="item form-group" style="margin-top:30px;">
                                             ...
                                             <div class="col-md-6 col-sm-6 ">
                                               <!--<input required="" onkeyup="akahr_bahar_f8()" onchange="addrandomf4()" type="text" name="amount_akahr_bahar_f8"  id="amount_akahr_bahar_f8" class="form-control" >-->
                                                      ...
                                                      <table id="datatable" class="table table-striped table-bordered" style="font-size: 12px; width: 99%; margin-bottom: 0rem; background-color: #ededed; ">
                                                         <thead>
                                                            <tr>
                                                               <th>
                                                                  <label>ANDER</label>
                                                                 <input required="" onkeyup="akahr_bahar_f8()" onchange="adddaraspacef8()" type="text" name="amount_akahr_bahar_f8"  id="amount_akahr_bahar_f8" class="form-control" placeholder="ANDER">
                                                               </th>
                                                               <th>
                                                                  <label> BAHAR</label>
                                                                 <input required="" onkeyup="akahr_bahar_f8()" onchange="adddaraspacef8()" type="text" name="amount_akahr_bahar_f8"  id="amount_akahr_bahar_f8" class="form-control" placeholder=" BAHAR">
                                                               </th>
                                                               <th>
                                                                  <label> AMOUNT </label>
...
<?php endif; ?>
                                          ...
                                          <span id="akbahar_dara"></span>
                                                               ...
                                                               <th>
                                                                  <label> To</label>
                                                                 <input required="" onkeyup="akahr_bahar_f8()" onchange="adddaraspacef8()" type="text" name="amount_akahr_bahar_f8"  id="amount_akahr_bahar_f8" class="form-control" placeholder="To">
                                                               </th>
                                                               <th>
                                                                  <label> Amount</label>
                                                                 <input required="" onkeyup="akahr_bahar_f8()" onchange="adddaraspacef8()" type="text" name="amount_akahr_bahar_f8"  id="amount_akahr_bahar_f8" class="form-control" placeholder="0">
                                                               </th>
                                                            </tr>
                                                         </thead>
                                                      </table>
...
someElementsItems[someElementsItems.length -1].focus();
   ...
   xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
   xhttp.send("number="+numb+"&thamount="+tamnatt+"&amount="+elem.value+"&shift="+shift+"&date="+date);
...
//}
   ...
   xhttp.open("POST", "add_cross", true);
   xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
   xhttp.send("ander="+ander+"&bahar="+bahar+"&amount="+amountt+"&joda="+joda+"&total_cross_count="+tcc+"&total_amount="+ta);
	 }
   }
   function calcfromto(){
...
//}
   ...
   xhttp.open("POST", "add_fromto", true);
   xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
   xhttp.send("fromto_from="+fromto_from+"&fromto_to="+fromto_to+"&fromto_amount="+fromto_amnt+"&total_amount_fromto="+product);
	 }   
   }
   ...
   xhttp.open("POST", "random_f8", true);
   xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
   xhttp.send( "ranf8amt="+ranf8amt+"&dara_f8="+dara_f8+"&dara_amount_f8="+dara_amount_f8+"&akhar_bahar_f8="+akhar_bahar_f8+"&akahr_andar_f8="+akahr_andar_f8+"&amount_akahr_bahar_f8="+amount_akahr_bahar_f8+"&amount_akahr_andar_f8="+amount_akahr_andar_f8);
	 }
   }
