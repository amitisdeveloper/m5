...
function crtof8() {
    ...
    for (var i = 0; i < dararatearr.length; i++) {
        ...
        tr.innerHTML = '<tr><th><input type="text" class="form-control" name="trn_number[]" value="' + dararatearr[i] +
            '" placeholder="Number" onkeyup="checkshift(this)" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" autocomplete="off" ></th> <th><input type="text" class="form-control" value="' +
            daraamnt +
            '" name="trn_amount[]" placeholder="Amount" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" autocomplete="off" ></th><td><span class="delete" onClick="$(this).parent().parent().remove();"> X </span></td></tr>';
                                                                            ...
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    <th><input type="text"
                                                                                            class="form-control"
                                                                                            name="trn_amount[]" 
                                                                                            placeholder="Amount" required></th>
