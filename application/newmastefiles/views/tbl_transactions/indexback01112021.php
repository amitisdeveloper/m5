									  ...
									  <form id="demo-form2" method="post" action="add_randomf4" data-parsley-validate class="form-horizontal form-label-left">
                                          <div class="item form-group" style="margin-top:30px;">
                                             ...
                                             <div class="col-md-6 col-sm-6 ">
                                                <input type="text" name="number[]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="2" id="first-name" required="required"   onchange="addrandomf4(this)"  class="form-control randomf4">
                                             </div>
                                          </div>
                                                      ...
                                                      <table id="datatable" class="table table-striped table-bordered" style="font-size: 12px; width: 99%; margin-bottom: 0rem; background-color: #ededed; ">
                                                         <thead>
                                                            <tr>
                                                               <th>
                                                                  <label>ANDER</label>
                                                                  <input type="text" onchange="checkcross()" maxLength='10' id="crossander" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" placeholder="Ander" name="ander" required>
                                                               </th>
                                                               </tr>
															   <tr><th>
                                                                  <label> BAHAR</label>
                                                                  <input type="text" onchange="checkcross()" maxLength='10' id="crossbahar" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" name="bahar" placeholder="Bahar" required>
                                                               </th>
															   </tr>
															   <tr>
                                                               <th>
...
<input type="hidden" name="is_filled" id="is_filled5" value="">
                                    <form class="" action="random_f8" method="post" novalidate>
                                       ...
                                       <input type="text" class="form-control" onkeyup="daraspacef8()" onchange="adddaraspacef8()" required="required" id="dara_f8" name="dara_f8" placeholder="Number, EG 01 And 09 Like 0189"> 
									   </div>
