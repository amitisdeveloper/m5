...
<form action="" name="search_final_ledger_agent" method="post">
...
<?php foreach($agent as $key => $val){ 
	echo '<option value="'.$val['id'].'" '.(($this->input->post('search_party')==$val['id']) ? 'selected' :'').'>'.$val['agent_name'].'</option>';
}?>
</select>
</div>
<!--<div class="col-md-3 col-sm-12  form-group"><label>Select Agent :</label>
