...
foreach($tdledger['today'] as $key => $vall){
...
//echo $nbopening.' nopening '; echo $bopening.' bopening ';echo $backvoucher.' backvoucher <br>'; 
}
//if($_POST['ledger_id']=='9'){
		//echo $nbopening.' nopening '; echo $bopening.' bopening ';echo $oldopening.' yesterdayopening ';
		//}
...
//$bopening = $nbopening+$bopening+$oldopening;
$bopening =$oldopening;
foreach($tdledger['today'] as $key => $val){
	if($val['finalsum']!='0'){
	?><tr>
