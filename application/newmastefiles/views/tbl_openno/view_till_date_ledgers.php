...
$bopening = $opening;
//$opening = get_client_coin_balance($_POST['ledger_id']);
$opening = get_latest_balance_till_date($_POST['ledger_id'],date('Y-m-d',strtotime($tdledger['today'][0]['Date'])));
?>
