...
<strong><?=$error?></strong>
								...
								<?php }?>
								<?php echo form_open('tbl_shift/add_admin',array("class"=>"form-horizontal")); ?>
                                    <div class="row">
               ...
               <span class="glyphicon glyphicon-time"></span>
                                        ...
                                        <div class="col-md-3 col-sm-12  form-group">
                                         ...
                                         <div class="input-group date datetimepicker3">
                                            <input name="super_admin" type="text" class="form-control " required>
											<span class="input-group-addon">
               <span class="glyphicon glyphicon-time"></span>
               </span>
			   </div>
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered" style="font-size:12px;">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th>Shift name</th>
                                            <th>Open Date</th>
                                            <th>Master Timings</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
									<?php foreach($tbl_shift as $key => $t){ ?>
                                        <tr>
		...
		<td>
            <a href="<?php echo site_url('tbl_shift/edit_admin/'.$t['id']); ?>" class="btn btn-info btn-xs">Edit</a>
