...
<strong><?=$error?></strong>
   ...
   <?php echo ($t['is_active'] == 1) ? 'Deactivate Shift' : 'Activate Shift'; ?>
        ...
        //} ?>
                                ...
                                <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo">Deactived Shifts</button>
...
<?php echo ($t['is_active'] == 1) ? 'Deactivate Shift' : 'Activate Shift'; ?>
           ...
           if($t['adminshift'] != 1){
            ?>
            <a href="<?php echo site_url('tbl_shift/remove/'.$t['id']); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete this shift?');">Remove</a>
            <?php
           }
           ?>
