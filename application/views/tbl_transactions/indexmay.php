<script src="https://master.bull99exch.com/assets/js/jquery.min.js"></script>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function($) {
        ...
        $('#demo-form2').submit(function(e) {
            ...
            var allowed = 1;
            $('input[name="trn_number[]"]').each(function() {
            ...
            if (allowed) {
                ...
                alert('100 Number found!! Please correct.');
                return false;
            }
        });
        $('.autosel').select2({
...
<script>
    ...
    function insertf4tof2() {
        ...
        for (index = 0; index < objarrr.length; index++) {
            ...
            if (objarrr[index] != "") {
                ...
                tr.innerHTML = '<tr><th><input type="text" class="form-control" name="trn_number[]" value="' + objarrr[
                    ...
                    elem.value +
                    '" name="trn_amount[]" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" placeholder="Amount" autocomplete="off"></th><td><button type="button" onClick="$(this).parent().parent().remove();" class="btn btn-outline-danger">Delete</button></td></tr>';
            }
        ...
        //const contentDiv = document.getElementById('randomform');
        // Empty the content of the div
        //contentDiv.innerHTML = '';

        // Insert new HTML content
        // contentDiv.innerHTML = '<input type="hidden" name="is_filled" id="is_filled2" value="" autocomplete="off"><div class="item form-group" style="margin-top:30px;"><label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Number<span class="required">*</span></label><div class="col-md-6 col-sm-6 "><input type="text" name="number[]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="2" id="first-name" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" onchange="addrandomf4(this)" class="form-control randomf4" autocomplete="off"></div></div><div class="item form-group"><label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Amount <span class="required">*</span></label><div class="col-md-6 col-sm-6 "><input type="number" id="amnt" name="randf4amountold" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" onchange="insertrandomf4(this)" onkeyup="calcf4(this)" class="form-control" autocomplete="off"></div></div><div class="item form-group"><label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Total Amount <span class="required">*</span></label><div class="col-md-6 col-sm-6 "><input type="text" id="tamount" name="tamount" class="form-control" readonly="" autocomplete="off"><input type="hidden" id="thamount" name="thamount" autocomplete="off"></div></div><div class="item form-group"><label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name"></label><div class="col-md-6 col-sm-6 "><input type="button" value="Save" name="save_f4" onclick="insertf4tof2()" autocomplete="off"></div></div><div class="ln_solid"></div>';
        $('#editrandom').html('');
        $('#editrandom').html('<div class="item form-group" style="margin-top:30px;"> <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name"> Number<span class="required">*</span> </label> <div class="col-md-6 col-sm-6 "> <input type="text" name="number[]" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="2" id="first-name" onchange="addrandomf4(this)" class="form-control randomf4" autocomplete="off"> </div> </div> <div class="item form-group"> <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name"> Amount <span class="required">*</span> </label> <div class="col-md-6 col-sm-6 "> <input type="number" id="amnt" name="randf4amountold" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" onchange="insertrandomf4(this)" onkeyup="calcf4(this)" class="form-control" autocomplete="off"> </div> </div> <div class="item form-group"> <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name"> Total Amount <span class="required">*</span> </label> <div class="col-md-6 col-sm-6 "> <input type="text" id="tamount" name="tamount" class="form-control" readonly="" autocomplete="off"> <input type="hidden" id="thamount" name="thamount" autocomplete="off"> </div> </div> <div class="item form-group"> <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name"> </label> <div class="col-md-6 col-sm-6 "> <input type="button" value="Save" name="save_f4" onclick="insertf4tof2()" autocomplete="off"> </div> </div>');
    ...
    function crtof8() {
        ...
        for (var i = 0; i < dararatearr.length; i++) {
            ...
            tr.innerHTML = '<tr><th><input type="text" class="form-control" name="trn_number[]" value="' + dararatearr[i] +
                '" placeholder="Number" onkeyup="checkshift(this)" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" autocomplete="off" ></th> <th><input type="text" class="form-control" value="' +
                daraamnt +
                '" name="trn_amount[]" placeholder="Amount" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" autocomplete="off" ></th><td><button type="button" onClick="$(this).parent().parent().remove();" class="btn btn-outline-danger">Delete</button></td></tr>';
        ...
        activeTab('home');
       // const contentDiv = document.getElementById('randomf8form');
        // Empty the content of the div
        //contentDiv.innerHTML = '';

        // Insert new HTML content
        //contentDiv.innerHTML = '<input type="hidden" name="is_filled" id="is_filled5" value="" autocomplete="off"><!--<form class="" action="random_f8" method="post" novalidate--><p style="font-size:14px;"><b> NOTE:</b> Dara number should be 2 digit without any separator.</p><p style="font-size:14px;margin-bottom:28px;"><b> NOTE:</b> Akhar number should be 1 digit without any separator.</p><div class="col-md-6 col-sm-12  form-group"><label>Dara <span class="required">*</span></label><textarea onkeyup="daraspacef8()" onchange="adddaraspacef8()" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" id="dara_f8" name="dara_f8" placeholder="Number, EG 01 And 09 Like 0189"></textarea><!--<input type="text" class="form-control" onkeyup="daraspacef8()" onchange="adddaraspacef8()"  id="dara_f8" name="dara_f8" placeholder="Number, EG 01 And 09 Like 0189"> --></div><div class="col-md-3 col-sm-12  form-group"><label>Amount<span class="required">*</span></label><label style="float:right;"><span id="amount_dara"></span></label><input onkeyup="daraspacef8()" type="number" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" onchange="adddaraspacef8()" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="dara_amount_f8" id="dara_amount_f8" class="form-control" placeholder="Amount" autocomplete="off"></div><div class="col-md-6 col-sm-12  form-group"><label>Akhar Bahar <span class="required">*</span></label><input onkeyup="akahr_bahar_f8()" type="number" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" onchange="adddaraspacef8()" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="akhar_bahar_f8" id="akhar_bahar_f8" class="form-control" placeholder="Number,EG: 1 And 2 Like 12" autocomplete="off"></div><div class="col-md-3 col-sm-12  form-group"><label>Amount <span class="required">*</span></label><label style="float:right;"><span id="akbahar_dara"></span></label><input onkeyup="akahr_bahar_f8()" onchange="adddaraspacef8()" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" type="text" name="amount_akahr_bahar_f8" id="amount_akahr_bahar_f8" class="form-control" placeholder="Amount" autocomplete="off"></div><div class="col-md-6 col-sm-12  form-group"><label>Akhar Andar <span class="required">*</span></label><input onkeyup="calc_akahr_andar_f8()" onchange="adddaraspacef8()" id="akahr_andar_f8" name="akahr_andar_f8" type="number" maxlength="10" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" placeholder="Numbers, EG: 1 And 2 Like 12" autocomplete="off"></div><div class="col-md-3 col-sm-12  form-group"><label>Amount <span class="required">*</span></label><label style="float:right;"><span id="akandar_dara"></span></label><input onkeyup="calc_akahr_andar_f8()" onchange="adddaraspacef8()" id="amount_akahr_andar_f8" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" name="amount_akahr_andar_f8" type="number" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" placeholder="Amount" autocomplete="off"></div><div class="col-md-6 col-sm-12  form-group"><p style="font-size:17px;"><b>Total Amount: <span id="f8_amount">0</span></b></p><input type="hidden" id="ranf8amt" name="ranf8amt" value="0" autocomplete="off"></div><div class="col-md-6 col-sm-6 offset-md-3" style="margin-left:3px;"><button class="btn btn-primary" onclick="crtof8()" type="button" style="padding: 0.375rem 2.75rem; ">Save</button></div>';
        $('#cr8edit').html('');
        $('#cr8edit').html('<div class="col-md-6 col-sm-12 form-group"> <label> Dara <span class="required">*</span> </label> <textarea onkeyup="daraspacef8()" onchange="adddaraspacef8()" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" id="dara_f8" name="dara_f8" placeholder="Number, EG 01 And 09 Like 0189"></textarea> <!--<input type="text" class="form-control" onkeyup="daraspacef8()" onchange="adddaraspacef8()" id="dara_f8" name="dara_f8" placeholder="Number, EG 01 And 09 Like 0189"> --> </div> <div class="col-md-3 col-sm-12 form-group"> <label> Amount<span class="required">*</span> </label> <label style="float:right;"> <span id="amount_dara">0</span> </label> <input onkeyup="daraspacef8()" type="number" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" onchange="adddaraspacef8()" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="dara_amount_f8" id="dara_amount_f8" class="form-control" placeholder="Amount" autocomplete="off"> </div> <div class="col-md-6 col-sm-12 form-group"> <label> Akhar Bahar <span class="required">*</span> </label> <input onkeyup="akahr_bahar_f8()" type="number" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" onchange="adddaraspacef8()" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="akhar_bahar_f8" id="akhar_bahar_f8" class="form-control" placeholder="Number,EG: 1 And 2 Like 12 " autocomplete="off"> </div> <div class="col-md-3 col-sm-12 form-group"> <label> Amount <span class="required">*</span> </label> <label style="float:right;"> <span id="akbahar_dara"></span> </label> <input onkeyup="akahr_bahar_f8()" onchange="adddaraspacef8()" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" type="text" name="amount_akahr_bahar_f8" id="amount_akahr_bahar_f8" class="form-control" placeholder="Amount" autocomplete="off"> </div> <div class="col-md-6 col-sm-12 form-group"> <label> Akhar Andar <span class="required">*</span> </label> <input onkeyup="calc_akahr_andar_f8()" onchange="adddaraspacef8()" id="akahr_andar_f8" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" name="akahr_andar_f8" type="number" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" placeholder="Numbers, EG: 1 And 2 Like 12" autocomplete="off"> </div> <div class="col-md-3 col-sm-12 form-group"> <label> Amount <span class="required">*</span> </label> <label style="float:right;"> <span id="akandar_dara"></span> </label> <input onkeyup="calc_akahr_andar_f8()" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" onchange="adddaraspacef8()" id="amount_akahr_andar_f8" name="amount_akahr_andar_f8" type="number" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" placeholder="Amount" autocomplete="off"> </div> <div class="col-md-6 col-sm-12 form-group"> <p style="font-size:17px;"> <b>Total Amount: <span id="f8_amount">0</span></b> </p> <input type="hidden" id="ranf8amt" name="ranf8amt" value="0" autocomplete="off"> </div>');
        
        return false;
    }

   function crtof7() {
    var fromfromVal = document.getElementById('fromto_from').value.trim();
    var frmtoVal = document.getElementById('fromto_to').value.trim();
    var frmamnt = document.getElementById('fromto_amount').value;

    // If user enters '00', treat it as 100
    if (fromfromVal === '00') {
        fromfromVal = '100';
    }
    if (frmtoVal === '00') {
    ...
    var fromfrom = parseInt(fromfromVal);
    var frmto = parseInt(frmtoVal);

    // Minimum value check
    if (fromfrom < 1) {
        alert("Minimum value allowed is 1.");
        return false;
    }
    ...
    for (var i = fromfrom; i <= frmto; i++) {
        ...
        // Display '00' instead of 100
        var displayValue = (i === 100) ? '00' : i;

        var tr = xTable.insertRow(index1);
        tr.innerHTML = '<tr><th><input type="text" class="form-control" name="trn_number[]" value="' + displayValue +
            '" placeholder="Number" onkeyup="checkshift(this)" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" autocomplete="off"></th> <th><input type="text" class="form-control" value="' +
            frmamnt +
            '" name="trn_amount[]" placeholder="Amount" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" autocomplete="off"></th><td><button type="button" onClick="$(this).parent().parent().remove();" class="btn btn-outline-danger">Delete</button></td></tr>';
    }

    var oldval = parseInt(document.getElementById('ttamntt').value || '0');
    var newval = parseInt(document.getElementById('fromto_total_amount').textContent || '0');
    document.getElementById('ttamntt').value = oldval + newval;

    activeTab('home');

    $('#datatablecr7').html('');
    $('#datatablecr7').html('<thead> <tr> <th> <label>From</label> <input type="number" onkeyup="calcfromto()" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" onchange="addfromto()" maxlength="3" id="fromto_from" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" name="fromto_from" placeholder="From" autocomplete="off"> </th> <th> <label> To</label> <input type="number" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" onkeyup="calcfromto()" onchange="addfromto()" maxlength="3" id="fromto_to" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" name="fromto_to" placeholder="To" autocomplete="off"> </th> <th> <label> Amount</label> <input type="text" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" onkeyup="calcfromto()" onchange="addfromto()" class="form-control" id="fromto_amount" name="fromto_amount" placeholder="Amount" autocomplete="off"> </th> </tr> </thead>');
    $('#cr7hidden').html('');
    $('#cr7hidden').html('<p style="font-size:17px;margin-top:19px;float: left;"> <b>Total Amount: <span id="fromto_total_amount">0</span></b> </p> <input type="hidden" name="total_amount_fromto" id="total_amount_fromto" value="" autocomplete="off">');
    ...
    function crtof2() {
        ...
        // const contentDiv = document.getElementById('crossform');
        // Empty the content of the div
        // contentDiv.innerHTML = '';


        // Insert new HTML content
        // contentDiv.innerHTML = '<div class="card-box table-responsive"><input type="hidden" name="is_filled" id="is_filled3" value="" autocomplete="off"><table id="datatable" class="table table-striped table-bordered" style="font-size: 12px; width: 99%; margin-bottom: 0rem; background-color: #ededed; "><thead><tr><th><label>ANDER</label><input type="text" onchange="checkcross()" maxlength="10" id="crossander" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" placeholder="Ander" name="ander" autocomplete="off"></th></tr><tr><th><label> BAHAR</label><input type="text" onchange="checkcross()" maxlength="10" id="crossbahar" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" name="bahar" placeholder="Bahar" autocomplete="off"></th></tr><tr><th><label> AMOUNT </label><input type="text" name="amount" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" onchange="checkcross()" id="amntt" class="form-control" placeholder="AMT" autocomplete="off"></th></tr><tr><th><label>JODA</label><select name="joda" id="joda" onchange="checkcross()" class="form-control"><option value="" disabled="">--Please Select--</option><option value="Y" selected="">Y</option><option value="N">N</option></select></th></tr><tr><th><input type="button" name="crsave" value="Save" onclick="crtof2()" autocomplete="off"></th></tr></thead></table><p style="font-size:17px;margin-top:19px;"><b>Total Cross Count: <span id="tcc">0</span></b></p><p style="font-size:17px;margin-top:19px;"><b>Total Amount: <span id="tamnt">0</span></b></p><input type="hidden" name="total_amount_cross" id="total_amount_cross" value="" autocomplete="off"><input type="hidden" name="cross_count" id="cross_count" value="" autocomplete="off"></div>';
        //return false;
        $('#datatablee').html('');
        $('#datatablee').html('<thead> <tr> <th> <label>ANDER</label> <input type="text" onchange="checkcross()" maxlength="10" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" id="crossander" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" placeholder="Ander" name="ander" autocomplete="off"> </th> </tr> <tr> <th> <label> BAHAR</label> <input type="text" onchange="checkcross()" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" maxlength="10" id="crossbahar" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" name="bahar" placeholder="Bahar" autocomplete="off"> </th> </tr> <tr> <th> <label> AMOUNT </label> <input type="text" name="amount" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57))" onchange="checkcross()" id="amntt" class="form-control" placeholder="AMT" autocomplete="off"> </th> </tr> <tr> <th> <label>JODA</label> <select name="joda" id="joda" onchange="checkcross()" class="form-control"> <option value="" selected="">--Please Select--</option> <option value="Y">Y </option> <option value="N">N </option> </select> </th> </tr> <tr> <th> <input type="button" name="crsave" value="Save" onclick="crtof2()" autocomplete="off"> </th> </tr> </thead>');
        $('#crosshidden').html('');
        $('#crosshidden').html('<p style="font-size:17px;margin-top:19px;"> <b>Total Cross Count: <span id="tcc">0</span></b> </p> <p style="font-size:17px;margin-top:19px;"> <b>Total Amount: <span id="tamnt">0</span></b> </p> <input type="hidden" name="total_amount_cross" id="total_amount_cross" value=""> <input type="hidden" name="cross_count" id="cross_count" value="">');
        //return false;
    }
</script>
<div class="">
    ...
    <?php //echo 'ttp'; 
    ?>
    <form id="demo-form2" method="post" action="add_transaction_final_may" data-parsley-validate
        class="form-horizontal form-label-left" onsubmit="checkFields(event)" novalidate>
        <input type="hidden" name="updated_by" value="<?= $_SESSION['updated_by'] ?>">
        <div class="row">
                    ...
                    <div class="x_title">
                        ...
                        <div class="nav navbar-right panel_toolbox">
                            <div class="form-group pull-right top_search">
                                <div class="input-group">
                                    ...
                                    ?>
                                        <input id="birthday" name="dateoftrn" class=" form-control" type="text"
                                            autocomplete="off" required>
                                    <?php
                                    }
                                    //if($_SESSION['role']=='Data Entry Operator'){
                                    else {
                                    ?>
                                        <input id="birthday" name="dateoftrn" value="<?= date('d-m-Y', strtotime('-12 hour', time())) ?>" class=" form-control" type="text"
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="#">Punjab Day</a>
                                ...
                                //echo '<pre>'; print_r($_SESSION['role']);print_r($shifts); echo '</pre>'; die; 
                                ...
                                <select name="shift" id="shift" onchange="selectshift(this)" class="form-control"
                                    ...
                                    <?php foreach($shifts as $key => $val){ //echo '<pre>'; print_r($_SESSION['role']);print_r($val); echo '</pre>'; die; 
										if($_SESSION['role']=='Admin' || $_SESSION['role']=='Super Admin'|| $_SESSION['role']=='Master'){ 
											...
											$time = strtotime(date('Y-m-d',strtotime($val['open_date'])).' '.date("H:i", strtotime($val['master'])));
										}
										if($_SESSION['role']=='Data Entry Operator' || $_SESSION['role']=='Staff'){
											$time = strtotime(date('Y-m-d',strtotime($val['open_date'])).' '.date("H:i", strtotime($val['data_entry_operator'])));
										}
										//echo  date_default_timezone_get(); die;
										//echo $ttime.'      '.$time.'<br>'; //die;
										
										if($ttime<$time){
										?>
										<option value="<?=$val['id']?>" selected><?=$val['shift_name']?></option>
										<?php	
										}
                                ...
                                date_default_timezone_set('Asia/Kolkata');
                                $ttime = time();
                                $nearest_time = PHP_INT_MAX; // Initialize to a large value
                                $nearest_shift_id = null; // To hold the ID of the nearest shift

                                ?>
                                <select name="shift" id="shift" onchange="selectshift(this)" class="form-control" required>
                                    <option value="">Choose option</option>
                                    <?php foreach ($shifts as $key => $val):
                                        ...
                                        if ($ttime < $time) {
                                            // Check if this time is the nearest future shift
                                            if ($time < $nearest_time) {
                                                $nearest_time = $time;
                                                $nearest_shift_id = $val['id']; // Store the ID of the nearest shift
                                            }
                                        }
                                    endforeach; ?>
                                    ...
                                    <?php foreach ($shifts as $key => $val):
                                        ...
                                        if ($ttime < $time) {
                                            $selected = ($val['id'] == $nearest_shift_id) ? 'selected' : '';
                                    ?>
                                            <option value="<?= $val['id'] ?>" <?= $selected ?>><?= $val['shift_name'] ?></option>
                                    <?php
                                        }
                            ...
                            <div class="btn-group" style="height: 36px; margin-right: 10px;">
                                <select name="party" id="party" class="form-control autosel" required>
                                    <option value="">Choose option</option>
                                ...
                                <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile"
                                            role="tab" aria-controls="profile" aria-selected="false">Random</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="From-To-tab" data-toggle="tab" href="#From-To"
                                            role="tab" aria-controls="From-To" aria-selected="false">From-To</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="Random-tab" data-toggle="tab" href="#Random" role="tab"
                                            aria-controls="Random" aria-selected="false">Random</a>
                                    </li>
                                    <li class="nav-item">
                                        ...
                                        <div class="x_content" style="background-color: #ededed;">
                                                    ...
                                                    <div class="x_panel" style="max-height: 263px;">
                                                        <div class="x_content">
                                                            <div class="row">
                                                                ...
                                                                <!--<div class="col-sm-12">
                                                                                    <div class="card-box table-responsive" style="max-height: 220px;">

                                                                                        <input type="hidden" name="is_filled" id="is_filled1" value="">
                                                                            ...
                                                                            <thead>
                                                                                <tr>
                                                                                    <th><input type="text"
                                                                                            ...
                                                                                            name="trn_number[]"
                                                                                            placeholder="Number"
                                                                                            onkeyup="checkshift(this)" onBlur="if (this.value == '100') { var field = this; setTimeout(function() { field.focus(); }, 0); }" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" id="lastrn" required></th>
                                                                                    <th><input type="text"
                                                                                            class="form-control"
                                                                                            name="trn_amount[]"
                                                                                            placeholder="Amount" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" required></th>
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                function bulkinss() {
                                                    ...
                                                    //var exist = = numberList.forEach((car, index) => car === '100' ? index : null);
                                                    //console.log(exist);
                                                    while ((i = numberList.indexOf('100', i + 1)) != -1) {
                                                        if (i % 2 == 0) {
                                                            alert('100 No not allowed!! Please try again.');
                                                            return false;
                                                        }
                                                    }
                                                    ...
                                                    for (var i = 0; i < numberList.length; i = i + 2) {
                                                        ...
                                                        newRow.innerHTML =
                                                            ...
                                                            numberList[i + 1] +
                                                            '" name="trn_amount[]" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" placeholder="Amount" ></th><td><button type="button" onClick="$(this).parent().parent().remove();" class="btn btn-outline-danger">Delete</button></td></tr>';
                                                        ...
                                                        ttotal = ttotal + parseInt(numberList[i + 1]);
                                                    }
                                                    var oldval = document.getElementById('ttamntt').value;
                                                                ...
                                                                <div class="item form-group" style="margin-top:30px;">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6 ">
                                                                        <input type="text" name="number[]"
                                                                            ...
                                                                            maxlength="2" id="first-name" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                                ...
                                                                <div class="item form-group">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6 ">
                                                                        <input type="number" id="amnt"
                                                                            name="randf4amountold" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                                                ...
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th>
                                                                                            ...
                                                                                            <input type="text"
                                                                                                onchange="checkcross()"
                                                                                                maxLength='10'
                                                                                                id="crossander" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                                                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                                                                                class="form-control"
                                                                                                placeholder="Ander"
                                                                                                name="ander">
                                                                                    ...
                                                                                    <tr>
                                                                                        <th>
                                                                                            ...
                                                                                            <input type="text"
                                                                                                onchange="checkcross()"
                                                                                                maxLength='10'
                                                                                                id="crossbahar" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                                                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                                                                                class="form-control"
                                                                                                name="bahar"
                                                                                                placeholder="Bahar">
                                                                                    ...
                                                                                    <tr>
                                                                                        <th>
                                                                                            <label> AMOUNT </label>
                                                                                            <input type="text"
                                                                                                name="amount" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                                                                onchange="checkcross()"
                                                                                                id="amntt"
                                                                                                class="form-control"
                                                                                                placeholder="AMT">
                                                                                ...
                                                                                <tr>
                                                                                    <th>
                                                                                        ...
                                                                                        <input type="number"
                                                                                            onkeyup="calcfromto()"
                                                                                            onchange="addfromto()"
                                                                                            maxLength='3' onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                                                            id="fromto_from"
                                                                                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                                                                            class="form-control"
                                                                                            name="fromto_from"
                                                                                    ...
                                                                                    <th>
                                                                                        <label> To</label>
                                                                                        <input type="number"
                                                                                            onkeyup="calcfromto()" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                                                            onchange="addfromto()"
                                                                                    ...
                                                                                    <th>
                                                                                        ...
                                                                                        <input type="text"
                                                                                            onkeyup="calcfromto()"
                                                                                            onchange="addfromto()" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                                                            class="form-control"
                                                                                            id="fromto_amount"
                                                                                            name="fromto_amount"
                                                                                            placeholder="Amount">
                                            ...
                                            <div class="x_content" style="background-color: #ededed;">
                                                <div class="col-md-8 col-sm-12 x_panel" style=" margin-top: 19px; ">
                                                    ...
                                                    <div id="cr8edit">
                                                        <div class="col-md-6 col-sm-12  form-group">
                                                            ...
                                                            <textarea onkeyup="daraspacef8()" onchange="adddaraspacef8()" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                        ...
                                                        <div class="col-md-3 col-sm-12  form-group">
                                                            ...
                                                            <input onkeyup="daraspacef8()" type="number" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                        ...
                                                        <div class="col-md-6 col-sm-12  form-group">
                                                            ...
                                                            <input onkeyup="akahr_bahar_f8()" type="number" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                                onchange="adddaraspacef8()" maxlength="10"
                                                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                             ...
                                             ">
                                                        ...
                                                        <div class="col-md-3 col-sm-12  form-group">
                                                            ...
                                                            <input onkeyup="akahr_bahar_f8()" onchange="adddaraspacef8()" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                        ...
                                                        <div class="col-md-6 col-sm-12  form-group">
                                                            ...
                                                            <input onkeyup="calc_akahr_andar_f8()"
                                                                ...
                                                                name="akahr_andar_f8" type="number" maxlength="10" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-md-3 col-sm-12  form-group">
                                                            ...
                                                            <input onkeyup="calc_akahr_andar_f8()"
                                                                onchange="adddaraspacef8()" id="amount_akahr_andar_f8" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
...
<script>
    //function enableshift() {    var date = new Date();    var time = date.getHours() + date.getMinutes();    if (date.getHours() >= '5' && date.getHours() < '16') {        document.getElementById('shift').value = '16';    }    if (date.getHours() >= '16' && date.getHours() < '17') {        document.getElementById('shift').value = '17';    }    if (date.getHours() >= '17' && date.getHours() < '18') {        document.getElementById('shift').value = '18';    }    if (date.getHours() >= '18' && date.getHours() < '21') {        document.getElementById('shift').value = '12';    }    if (date.getHours() >= '21' && date.getHours() < '24') {        document.getElementById('shift').value = '13';    }    if (date.getHours() >= '24' && date.getHours() < '4') {        document.getElementById('shift').value = '14';    }}enableshift();
</script>
<script>
    function calljantri() {
        ...
        var custurl = '?shift=' + document.getElementById('shift').value + '&party=' + document.getElementById('party')
            .value + '&tdate=' + document.getElementById('birthday').value;
        window.location.replace("/jantri" + custurl);
    }

    function checkshift(elem) { //alert(elem.value);
        if (document.getElementById('shift').value == '') {
            alert('Please Select Shift First');
            document.getElementById('shift').focus();
            return false;
...
alert(total); 
    ...
    // this is the last one
        ...
        elem.parentNode.parentNode.insertAdjacentHTML('afterend',
            '<tr><th><input type="text" class="form-control" name="trn_number[]" placeholder="Number" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" onkeyup="checkshift(this)" autofocus></th> <th><input type="text" class="form-control" name="trn_amount[]" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" placeholder="Amount" ></th></tr>'
        );
        ...
        //elem.parentNode.parentNode.insertAdjacentHTML('afterend','<tr><th><input type="text" class="form-control" name="trn_number[]" placeholder="Number" onkeyup="checkshift(this)"></th> <th><input type="text" class="form-control" name="trn_amount[]" placeholder="Amount" ></th></tr>');
...
//alert(lastchildd.value)
   ...
   */
    ...
    //         elem.parentNode.insertAdjacentHTML('afterend',
    //             '<div class="col-form-label col-md-3 col-sm-3"><button type="button" onClick="$(this).parent().parent().remove();" class="btn btn-outline-danger">Delete</button> </div>'
    //         );
    //         elem.parentNode.parentNode.insertAdjacentHTML('afterend',
    //             '<div class="item form-group" > <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name"> Number </label> <div class="col-md-6 col-sm-6 "> <input type="number" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="2" id="first-name" autofocus onchange="addrandomf4(this)" name="number[]" class="form-control randomf4"> </div> </div>'
    //         );
    ...
    function addrandomf4(elem) {
        // Ensure value is valid and not empty
        if (elem.value !== '' && elem.value !== '1' && elem.value !== '-1' && !isNaN(elem.value)) {
            // Add delete button next to the input
            elem.parentNode.insertAdjacentHTML('afterend',
                '<div class="col-form-label col-md-3 col-sm-3"><button type="button" onClick="$(this).parent().parent().remove(); validateRows();" class="btn btn-outline-danger">Delete</button></div>'
            );
            // Add a new row for input
            elem.parentNode.parentNode.insertAdjacentHTML('afterend',
                '<div class="item form-group"> \
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name"> Number </label> \
                <div class="col-md-6 col-sm-6"> \
                    <input type="number" \
            ...
            // Recalculate or revalidate rows if necessary
            calcf4();
        }
    }

    // Function to validate and handle rows after deletion
    function validateRows() {
        var inputs = document.querySelectorAll(".randomf4");
        inputs.forEach((input, index) => {
            if (input.value === '') {
                input.parentNode.parentNode.remove(); // Remove empty rows
            }
        });
        calcf4(); // Recalculate if needed
    }
    ...
    function insertrandomf44(elem) {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                //elem.parentNode.parentNode.insertAdjacentHTML('afterend','<tr><th><input type="text" class="form-control" placeholder="Number" onkeyup="checkshift(this)"></th> <th><input type="text" class="form-control" name="amount" placeholder=" Amount" onchange="addnumamount(this)"></th></tr>');
            }
        };
        xhttp.open("POST", actionstr, true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
