            ...
            <div class="x_title">
               ...
               <div class="nav navbar-left panel_toolbox"> 
                  ...
                  <div class="btn-group" style="height: 36px; margin-right: 10px;">
                     ...
                     <select name="shift" id="shift" onchange="selectshift(this)" disabled class="form-control">
                        <option value="">Choose option</option>
                        <?php foreach($shifts as $key => $val){
                           ?>
                        <option value="<?=$val['id']?>" <?=($val['id']==$tbl_transactions[0]['shiftid'])?'selected':''?>><?=$val['shift_name']?></option>
                        <?php	
                           } ?>
                     </select>
                     <div class="alert" style="display:none">Please Select Shift First</div>
                  ...
                  <div class="btn-group" style="height: 36px; margin-right: 10px;">
                      <select name="party" id="party"  class="form-control" disabled>
                        <option value="">Choose option</option>
                        <?php foreach($party as $key => $val){
                           ?>
                        <option value="<?=$val['id']?>" <?=($val['id']==$tbl_transactions[0]['ledgerid'])?'selected':''?>><?=$val['ledger_name']?></option>
                        <?php	
                           } ?>
                     </select>
...
<?php if($this->session->flashdata('msg')): ?>
    <p class="flsh button-success"><?php echo $this->session->flashdata('msg'); ?></p>
<?php endif; ?>									
<input type="hidden" name="is_filled" id="is_filled2" value="<?=$tbl_transactions[0]['id']?>">
									  <form id="demo-form2" method="post" action="add_randomf4" data-parsley-validate class="form-horizontal form-label-left">
										  ...
										  for($i=0; $i<count($numb);$i++){
                                             ...
                                             <div class="col-md-6 col-sm-6 ">
                                                <input type="number" value="<?=$numb[$i]?>" name="number[]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="2" id="first-name" required="required"   onchange="addrandomf4(this)"  class="form-control randomf4">
                                             </div>
                                          </div>
											  <?php
										  } ?>
                                          ...
                                          <div class="item form-group">
                                             ...
                                             <div class="col-md-6 col-sm-6 ">
                                                <input type="number" id="amnt" name="amount" value="<?=$tbl_transactions[0]['amount']?>" onchange="insertrandomf4(this)"  onkeyup="calcf4(this)" required="required" class="form-control">
                                             </div>
                                          </div>
                                          <div class="item form-group">
                                             <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">
    ...
    <p class="flsh button-success"><?php echo $this->session->flashdata('msg'); ?></p>
<?php endif; ?>
<input type="hidden" name="is_filled" id="is_filled3" value="<?=$tbl_transactions[0]['id']?>">
                                                      ...
                                                      <table id="datatable" class="table table-striped table-bordered" style="font-size: 12px; width: 99%; margin-bottom: 0rem; background-color: #ededed; ">
                                                         <thead>
                                                            <tr>
                                                               <th>
                                                                  <label>ANDER</label>
                                                                  <input type="text" onchange="checkcross()" value="<?=$tbl_transactions[0]['ander']?>" maxLength='3' id="crossander" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" placeholder="Ander" name="ander" required>
                                                               </th>
                                                               </tr>
															   <tr><th>
                                                                  <label> BAHAR</label>
                                                                  <input type="text" onchange="checkcross()" value="<?=$tbl_transactions[0]['bahar']?>" maxLength='3' id="crossbahar" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" name="bahar" placeholder="Bahar" required>
                                                               </th>
															   </tr>
															   <tr>
                                                               <th>
                                                                  <label> AMOUNT </label>
                                                                  <input type="text" name="amount" onchange="checkcross()" value="<?=$tbl_transactions[0]['trncrs_amt']?>" id="amntt" class="form-control" placeholder="AMT" required>
                                                               </th>
															   </tr>
															   <tr>
                                                               <th>
    ...
    <p class="flsh button-success"><?php echo $this->session->flashdata('msg'); ?></p>
<?php endif; ?>
<input type="hidden" name="is_filled" id="is_filled4" value="<?=$tbl_transactions[0]['id']?>">
                                                      ...
                                                      <table id="datatable" class="table table-striped table-bordered" style="font-size: 12px; width: 99%; margin-bottom: 0rem; background-color: #ededed; ">
                                                         <thead>
                                                            <tr>
                                                               <th>
                                                                  <label>From</label>
                                                                  <input required type="number" value="<?=$tbl_transactions[0]['fromto_from']?>" onkeyup="calcfromto()" onchange="addfromto()" maxLength='3' id="fromto_from" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" name="fromto_from" placeholder="From">
                                                               </th>
                                                               <th>
                                                                  <label> To</label>
                                                                  <input required type="number" value="<?=$tbl_transactions[0]['fromto_to']?>" onkeyup="calcfromto()" onchange="addfromto()" maxLength='3' id="fromto_to" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" name="fromto_to" placeholder="To">
                                                               </th>
                                                               <th>
                                                                  <label> Amount</label>
                                                                  <input required type="text" value="<?=$tbl_transactions[0]['fromto_amount']?>" onkeyup="calcfromto()" onchange="addfromto()" class="form-control" id="fromto_amount" name="fromto_amount" placeholder="Amount">
                                                               </th>
                                                            </tr>
                                                         </thead>
                                                      </table>
    ...
    <p class="flsh button-success"><?php echo $this->session->flashdata('msg'); ?></p>
<?php endif; ?>
<input type="hidden" name="is_filled" id="is_filled5" value="<?=$tbl_transactions[0]['id']?>">
                                    <form class="" action="random_f8" method="post" novalidate>
                                       ...
                                       <div class="col-md-3 col-sm-12  form-group">
                                          ...
                                          <input onkeyup="daraspacef8()" required type="number" value="<?=$tbl_transactions[0]['dara_amount_f8']?>" onchange="adddaraspacef8()" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="dara_amount_f8"  id="dara_amount_f8" class="form-control" placeholder="Amount">
                                       </div>
                                       <div class="col-md-6 col-sm-12  form-group">
                                          <label>
                                          Akhar Bahar <span class="required">*</span>
                                          </label>
                                          <input required onkeyup="akahr_bahar_f8()" type="number" value="<?=$tbl_transactions[0]['akhar_bahar_f8']?>" onchange="adddaraspacef8()" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="akhar_bahar_f8" id="akhar_bahar_f8" class="form-control" placeholder="Number,EG: 1 And 2 Like 12
                                             ">
                                       </div>
                                       <div class="col-md-3 col-sm-12  form-group">
                                          <label>
                                          ...
                                          <input required onkeyup="akahr_bahar_f8()" value="<?=$tbl_transactions[0]['amount_akahr_bahar_f8']?>" onchange="adddaraspacef8()" type="text" name="amount_akahr_bahar_f8"  id="amount_akahr_bahar_f8" class="form-control" placeholder="Amount">
                                       </div>
                                       <div class="col-md-6 col-sm-12  form-group">
                                          <label>
                                       ...
                                       <div class="col-md-6 col-sm-12  form-group">
                                          ...
                                          <input type="hidden" id="ranf8amt" name="ranf8amt" value="<?=$tbl_transactions[0]['total_amount']?>">
                                       </div>
                                       <!--<div class="col-md-6 col-sm-6 offset-md-3" style="margin-left:3px;">
                                          <button class="btn btn-primary" type="submit" style="padding: 0.375rem 2.75rem; ">Save</button>
                                          <button type="submit" class="btn btn-success" style="padding: 0.375rem 2.75rem; ">Cancel</button>
