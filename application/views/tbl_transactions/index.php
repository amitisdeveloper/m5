<div class="">
  ...
  <?php //echo 'ttp'; ?>
<form id="demo-form2"  method="post" action="add_transaction_final" data-parsley-validate class="form-horizontal form-label-left" onsubmit="checkFields(event)">
  <div class="row">
            ...
            <div class="x_title">
               ...
               <div class="nav navbar-right panel_toolbox">
                  <div class="form-group pull-right top_search">
                     ...
                     <input id="birthday" name="dateoftrn" class=" form-control" type="text" autocomplete="off"  required >
                                                                        ...
                                                                        <div class="x_content">
                                                                            <div class="row">
                                                                                <div class="col-sm-12">
																					...
																					<input type="button" id="bulkinsbtn" name="insert" value="insert" onclick="return bulkinss()" autocomplete="off" disabled>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-sm-12">
                                                                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                                                                        ...
                                                                                        <tr></tr>-->
                                                                                        <tbody><tr style="font-size:17px; text-align:center;">
                                                                                            <th>Total Amount: <span id="tf2amt" style="color:#000">0</span></th>
                                                                                        </tr>
                                                                                    </tbody></table>
                                                                                </div>
                                                                                <div class="col-sm-12">
                                                                                    <div class="card-box table-responsive" style="max-height: 220px;">
                                                                                        ...
                                                                                        <input type="hidden" name="is_filled" id="is_filled1" value="" autocomplete="off">
                                                                                        <input type="hidden" name="last_id1" id="last_id1" value="" autocomplete="off">
                                                                                        <table id="addtrn">
                                                                                            <thead>
                                                                                                <tr><th><input type="text" class="form-control" name="trn_number[]" placeholder="Number" onkeyup="checkshift()"></th> <th><input type="text" class="form-control" name="trn_amount[]" placeholder="Amount"></th></tr>
																						</thead>
                                                                                        </table>
                                                                                        <!--</form>-->
                                                                                    </div>
                                                            ...
                                                            <script type="text/javascript">
                                                                ...
                                                                function bulkinss(){
                                                                    ...
                                                                    for (var i = 0; i < numberList.length; i=i+2) {
                                                                        ...
                                                                        newRow.innerHTML='<tr><th><input type="text" class="form-control" name="trn_number[]" value="'+numberList[i]+'" placeholder="Number" onkeyup="checkshift()"></th> <th><input type="text" class="form-control" value="'+numberList[i+1]+'" name="trn_amount[]" placeholder="Amount" ></th></tr>';
                                                                    ...
                                                                    document.getElementById('addtrnhead').insertAdjacentHTML('afterend',document.getElementById('addtrn').innerHTML);
									 ...
									 <!-- <form id="demo-form2" method="post" action="add_randomf4" data-parsley-validate class="form-horizontal form-label-left">-->
                                          <div class="item form-group" style="margin-top:30px;">
                                             ...
                                             <div class="col-md-6 col-sm-6 ">
                                                <input type="text" name="number[]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="2" id="first-name"    onchange="addrandomf4(this)"  class="form-control randomf4">
                                             </div>
                                          </div>
                                          <div class="item form-group">
                                             ...
                                             <div class="col-md-6 col-sm-6 ">
                                                <input type="number" id="amnt" name="randf4amount" onchange="insertrandomf4(this)"  onkeyup="calcf4(this)"  class="form-control">
                                             </div>
                                          </div>
                                          <div class="item form-group">
                                             <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">
                                          ...
                                          <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">
                                             ...
                                             <div class="col-md-6 col-sm-6 ">
                                            <!-- <input type="button" name="savef4" onclick="savef4()" value="save f4" >-->
                                             </div>
                                                      ...
                                                      <table id="datatable" class="table table-striped table-bordered" style="font-size: 12px; width: 99%; margin-bottom: 0rem; background-color: #ededed; ">
                                                         <thead>
                                                            <tr>
                                                               <th>
                                                                  <label>ANDER</label>
                                                                  <input type="text" onchange="checkcross()" maxLength='10' id="crossander" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" placeholder="Ander" name="ander">
                                                               </th>
                                                               </tr>
															   <tr><th>
                                                                  <label> BAHAR</label>
                                                                  <input type="text" onchange="checkcross()" maxLength='10' id="crossbahar" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" name="bahar" placeholder="Bahar">
                                                               </th>
															   </tr>
															   <tr>
                                                               <th>
                                                                  <label> AMOUNT </label>
                                                                  <input type="text" name="amount" onchange="checkcross()" id="amntt" class="form-control" placeholder="AMT">
                                                               </th>
															   </tr>
															   <tr>
                                                               <th>
                                                      ...
                                                      <table id="datatable" class="table table-striped table-bordered" style="font-size: 12px; width: 99%; margin-bottom: 0rem; background-color: #ededed; ">
                                                         <thead>
                                                            <tr>
                                                               <th>
                                                                  <label>From</label>
                                                                  <input type="number" onkeyup="calcfromto()" onchange="addfromto()" maxLength='3' id="fromto_from" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" name="fromto_from" placeholder="From">
                                                               </th>
                                                               <th>
                                                                  <label> To</label>
                                                                  <input type="number" onkeyup="calcfromto()" onchange="addfromto()" maxLength='3' id="fromto_to" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" name="fromto_to" placeholder="To">
                                                               </th>
                                                               <th>
                                                                  <label> Amount</label>
                                                                  <input type="text"  onkeyup="calcfromto()" onchange="addfromto()" class="form-control" id="fromto_amount" name="fromto_amount" placeholder="Amount">
                                                               </th>
                                                            </tr>
                                                         </thead>
                                                      </table>
...
<input type="hidden" name="is_filled" id="is_filled5" value="">
                                    <!--<form class="" action="random_f8" method="post" novalidate>-->
                                       ...
                                       <div class="col-md-6 col-sm-12  form-group">
                                          ...
                                          <textarea onkeyup="daraspacef8()" onchange="adddaraspacef8()"  id="dara_f8" name="dara_f8" placeholder="Number, EG 01 And 09 Like 0189"></textarea>
                                       ...
                                       <div class="col-md-3 col-sm-12  form-group">
                                          ...
                                          <input onkeyup="daraspacef8()" type="number" onchange="adddaraspacef8()" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="dara_amount_f8"  id="dara_amount_f8" class="form-control" placeholder="Amount">
                                       </div>
                                       <div class="col-md-6 col-sm-12  form-group">
                                          <label>
                                          Akhar Bahar <span class="required">*</span>
                                          </label>
                                          <input onkeyup="akahr_bahar_f8()" type="number" onchange="adddaraspacef8()" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="akhar_bahar_f8" id="akhar_bahar_f8" class="form-control" placeholder="Number,EG: 1 And 2 Like 12
                                             ">
                                       </div>
                                       <div class="col-md-3 col-sm-12  form-group">
                                          <label>
                                          ...
                                          <input onkeyup="akahr_bahar_f8()" onchange="adddaraspacef8()" type="text" name="amount_akahr_bahar_f8"  id="amount_akahr_bahar_f8" class="form-control" placeholder="Amount">
                                       </div>
                                       <div class="col-md-6 col-sm-12  form-group">
                                          <label>
                                          Akhar Andar  <span class="required">*</span>
                                          </label>
                                          <input onkeyup="calc_akahr_andar_f8()" onchange="adddaraspacef8()" id="akahr_andar_f8" name="akahr_andar_f8" type="number" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" placeholder="Numbers, EG: 1 And 2 Like 12">
                                       </div>
                                       <div class="col-md-3 col-sm-12  form-group">
                                          <label>
                                          Amount <span class="required">*</span>
                                          ...
                                          <input onkeyup="calc_akahr_andar_f8()" onchange="adddaraspacef8()" id="amount_akahr_andar_f8" name="amount_akahr_andar_f8"   type="number" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" placeholder="Amount">
                                       </div>
                                       <div class="col-md-6 col-sm-12  form-group">
...
function calljantri(){
   ...
   if(document.getElementById('birthday').value==''){
	 ...
	 var custurl = '?shift='+document.getElementById('shift').value+'&party='+document.getElementById('party').value+'&tdate='+document.getElementById('birthday').value;
