    ...
    function crtof8() {
        ...
        for (var i = 0; i < dararatearr.length; i++) {
            ...
            tr.innerHTML = '<tr><th><input type="text" class="form-control" name="trn_number[]" value="' + dararatearr[i] +
                ...
                '" name="trn_amount[]" placeholder="Amount" autocomplete="off" ></th><td><span class="delete" onClick="$(this).parent().parent().remove();"> X </span></td></tr>';
...
<div class="">
    ...
    <form id="demo-form2" method="post" action="/tbl_transactions/edit_transaction_final_master/<?= $tbl_transactions[0]['id'] ?>" data-parsley-validate
                                                                    ...
                                                                    <div class="card-box table-responsive"
                                                                        ...
                                                                        <table id="addtrn">
                                                                            ...
                                                                            <thead>
                                                                                ...
                                                                                <tr>
                                                                                    <th><input type="text" class="form-control" name="trn_number[]" placeholder="Number" onkeyup="checkshift(this)" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" autofocus></th>
                                                                                    <th><input type="text" class="form-control" name="trn_amount[]" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" placeholder="Amount"></th>
                                                                                </tr>
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                function bulkinss() {
                                                    ...
                                                    for (var i = 0; i < numberList.length; i = i + 2) {
                                                        ...
                                                        //.insertAdjacentHTML('afterend','<tr><th><input type="text" class="form-control" name="trn_number[]" placeholder="Number" onkeyup="checkshift(this)" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" ></th> <th><input type="text" class="form-control" name="trn_amount[]" placeholder="Amount" ></th></tr>');
                                                            ...
                                                            <div id="editrandom">
                                                                <div class="item form-group" style="margin-top:30px;">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6 ">
                                                                        ...
                                                                        <input type="text" name="number[]" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <th>
                                                                                            ...
                                                                                            <input type="text"
                                                                                                ...
                                                                                                maxLength='10' onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <th>
                                                                                            ...
                                                                                            <input type="text"
                                                                                                ...
                                                                                                onchange="checkcross()" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                             ...
                                             ">
                                                        ...
                                                        <div class="col-md-6 col-sm-12  form-group">
                                                            ...
                                                            <input onkeyup="calc_akahr_andar_f8()"
                                                                ...
                                                                onchange="adddaraspacef8()" id="akahr_andar_f8" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                        ...
                                                        <div class="col-md-3 col-sm-12  form-group">
                                                            ...
                                                            <input onkeyup="calc_akahr_andar_f8()" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
