          ...
          <div class="left_col scroll-view">
            ...
            <br />
              ...
              <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                ...
                <li><a href="<?php echo base_url(); ?>user_hisab_agent">Agent Wise Hisab</a></li>
								  </ul>
...
function addtrnjanab(elem,atype){ //alert(atype);
if(atype=='b'){
		//alert(elem.id);
		document.getElementById('trn_number').innerHTML += '<input type="hidden" name="trn_number[]" value="'+elem.id+elem.id+elem.id+'" >';
        }
		if(atype=='a'){
		///alert(elem.id);
		document.getElementById('trn_number').innerHTML += '<input type="hidden" name="trn_number[]" value="'+elem.id+elem.id+elem.id+elem.id+'" >';
        }
}
...
<script>
  $('.birthday').datepicker().datepicker('setDate', new Date());
	...
	if(valLength>=3&&valLength<=5){ console.log(checkSameDigits(val))
