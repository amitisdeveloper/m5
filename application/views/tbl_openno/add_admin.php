...
<strong><?php echo @$this->session->flashdata('message');?></strong>
								...
								<?php }
								?>
								<?php echo form_open('tbl_openno/add_admin',array("class"=>"form-horizontal")); ?>
                                    <div class="row">
		...
		<td>
            <a href="<?php echo site_url('tbl_openno/edit_admin/'.$t['id']); ?>" class="btn btn-info btn-xs">Edit</a></td> 
