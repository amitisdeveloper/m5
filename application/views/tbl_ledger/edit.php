                                          ...
                                          <tr style="vertical-align: top;">
                                             ...
                                             <th style="width: 33%;">
                                                ...
                                                <div class="d-flex gap-2">
                                                   <div style="flex: 1;">
                                                      ...
                                                      <input name="dara_commision" value="<?= !empty($tbl_ledger['dara_commision']) ? $tbl_ledger['dara_commision'] : 0 ?>" id="dara_commision" maxlength="5" type="text" class="form-control">
                                                   </div>
                                                   <div style="flex: 1;">
                                                      <label style="font-size: 11px;">Master Comm</label>
                                                      <input name="dara__master_commision" value="<?= !empty($tbl_ledger['dara__master_commision']) ? $tbl_ledger['dara__master_commision'] : 0 ?>" id="dara__master_commision" maxlength="5" type="text" class="form-control">
                                                   </div>
                                                </div>
                                             </th>
                                             ...
                                             <th style="width: 33%;">
                                                ...
                                                <div class="d-flex gap-2">
                                                   <div style="flex: 1;">
                                                      <label style="font-size: 11px;">Party Comm</label>
                                                      <input name="akhar_commission" value="<?= !empty($tbl_ledger['akhar_commission']) ? $tbl_ledger['akhar_commission'] : 0 ?>" id="akhar_commission" maxlength="5" type="text" class="form-control">
                                                   </div>
                                                   <div style="flex: 1;">
                                                      <label style="font-size: 11px;">Master Comm</label>
                                                      <input name="akhar__master_commision" value="<?= !empty($tbl_ledger['akhar__master_commision']) ? $tbl_ledger['akhar__master_commision'] : 0 ?>" id="akhar__master_commision" maxlength="5" type="text" class="form-control">
                                                   </div>
                                                </div>
                                             </th>
